...
class driver_configure():
    def get_driver(self):
        ...
        try:
            ...
            self.desired_caps['platformVersion'] = '8.0'  # 系统版本
            # self.desired_caps['app'] = 'E:/autotestingPro/app/UCliulanqi_701.apk'   # 指向.apk文件，如果设置appPackage和appActivity，那么这项会被忽略
            self.desired_caps['appPackage'] = 'com.yichuan'     # APK包名
            self.desired_caps['appActivity'] = 'com.yichuan.activity.SplashActivity'     # 被测程序启动时的Activity
            ...
            self.desired_caps['deviceName'] = 'Android'     # 手机ID
